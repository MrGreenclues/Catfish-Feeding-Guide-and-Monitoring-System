...
<form  method="POST" action="Ehealtguideconn.php" class="form-border">
<input type="hidden" name="act_id" value="<?= $med_act['id']; ?>">
  <div class="mb-3">
    <label for="medicine" class="form-label">Medicine</label>
    <input type="text" id="inputfeeding" name="medicine" class="form-control" placeholder="Medicine" >
  </div>
  <div class="mb-3">
    <label for="Pond" class="form-label">Pond</label>
    <input type="text" name="pond" id="inputpond" class="form-control"  placeholder="Pond">
  </div>
  <div class="mb-3">
    <label for="time" class="form-label">Time</label>
    <input type="time" name="time" id="inputtime" class="form-control"  placeholder="Time">
  </div>
  <div class="mb-3">
    <label for="date" class="form-label">Date</label>
    <input type="Date" name="date"  id="inputdate" class="form-control" name="date" placeholder="Date">
  </div>
  ...
  <table class="table">
    <thead>
        ...
        <tbody id="tableBody">
            ...
            $query_run = mysqli_query($conn,$query);
            if(mysqli_num_rows($query_run)>0){
              while($medicine=mysqli_fetch_assoc($query_run)){
              ?>
                <tr> 
                  <td><?=$medicine['pond'];?></td>
