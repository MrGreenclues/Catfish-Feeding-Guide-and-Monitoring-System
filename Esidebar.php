...
<div class="sidebar-container">
  <ul class="nav flex-column">
    <li class="nav-item">
      <a class="nav-link" href="EfeedingGuide.php">Feeding Guide</a>
    </li>
    <li class="nav-item">
      <a class="nav-link" href="Ehealthguide.php">Health Guide</a>
    </li>
    <li class="nav-item">
      <a class="nav-link" href="Emanagepond.php">Manage Ponds</a>
    </li>
